...
define('DATE_FORMAT_LONG', '%B %d, %Y'); // this is used for strftime()
...
define('BOX_INFORMATION_EVENTS', 'Local Events');
// End About Us Add
...
define('ENTRY_COMPANY_TAX_ID', 'Company Tax Id:');
define('ENTRY_COMPANY_TAX_ID_TEXT', 'Company Tax Id');
...
define('TEXT_ENTER_GV_CODE', 'Enter Promotional Code ');
// #################### End Added CGV JONYO ######################
...
define('TEXT_AGREE','I agree to terms & conditions.');
define('TEXT_DISCLAIMER_ERROR','Please read the disclaimer.');
define('TEXT_DISCLAIMER_ANCHOR','<sup>&dagger;</sup>');
define('TABLE_HEADING_PRICE','Price');
define('TABLE_HEADING_COMMENTS2','Comments');

define('HIDE_PRICE_TEXT','Add to cart to see price');
define('TEXT_ACCORDING_TO_PRICE', 'Your Price');
...
// bundled products
define('TEXT_NO_CHECKOUT_BUNDLE_ONLY', 'You are not allowed to check out when any products sold only as a part of a package are in your cart. Please remove any items marked as not for separate sale.');
define('TEXT_NOT_AVAILABLEINSTOCK', ' Package is not in Stock ');
...
define('IMAGE_BUTTON_SHIP_ESTIMATOR', 'Ship Estimator');
