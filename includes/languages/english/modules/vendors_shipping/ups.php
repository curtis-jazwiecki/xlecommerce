...
/*
  ...
  $Loc: /catalog/includes/languages/english/modules/vendors_shipping/ $
...
define('MODULE_SHIPPING_ERROR_NO_QUOTE', 'We are unable to obtain a rate quote for UPS shipping.<br>Please contact the store if no other alternative is shown.');
?>
