...
define("TEXT_SELECT_PAYMENT_METHOD", "We Accept: Visa, MasterCard, Discover Card and American Express");
define("TITLE_PLEASE_SELECT", "Please Select");
define("TEXT_ENTER_SHIPPING_INFORMATION", "This is currently the only shipping method available to use on this order.");
define("TEXT_ENTER_PAYMENT_INFORMATION", "We Accept: Visa, MasterCard, Discover Card and American Express");
define("TABLE_HEADING_COMMENTS", "Add Comments About Your Order");
define("TITLE_CONTINUE_CHECKOUT_PROCEDURE", "Please ensure your information is correct");
define("TEXT_CONTINUE_CHECKOUT_PROCEDURE", "Click Confirm Order to complete your order");
...
define("EMAIL_SUBJECT", "Welcome to OBN/Kroll Demonstration Site");
define("EMAIL_GREET_MR", "Dear Mr. %s,");
define("EMAIL_GREET_MS", "Dear Ms. %s,");
define("EMAIL_GREET_NONE", "Dear %s");
define("EMAIL_WELCOME", "Welcome to <b>OBN/Kroll Demonstration Site</b>.");
...
define("EMAIL_CONTACT", "For help with any of our online services, please email customer service at: devteam@cloudcommerce.org.");
define("EMAIL_WARNING", "<b>Note:</b> This email address was given to us by one of our customers. If you did not signup to be a member, please send an email to devteam@cloudcommerce.org.");
...
define("TEXT_MULTIPLE_SHIPPING_METHODS", "Multiple Shipping Methods");
?>