...
define('HEADING_SEARCH_CRITERIA', 'Search Criteria: Please enter keywords into the text box below.');
...
define('TABLE_HEADING_COMPARE', 'Select Items &amp; Click Here to Compare'); // Compare products side-by-side
?>