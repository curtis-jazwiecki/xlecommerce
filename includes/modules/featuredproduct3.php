...
if(FEATURED_PRODUCTS_DISPLAY == 'true'){
	...
	/*if (file_exists(DIR_FS_CATALOG . DIR_WS_IMAGES. 'featured_header.jpg')) {
		...
		$heading = '<a class="headerNavigation" href="' . tep_href_link(FILENAME_FEATURED_PRODUCTS) . '">' .THREE_FEATURED_PRODUCT_TITLE . '</a>';
	//}
