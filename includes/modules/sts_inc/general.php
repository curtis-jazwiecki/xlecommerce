<?php
/*
$Id: general.php,v 4.3 2005/11/03 05:57:21 rigadin Exp $
...
$sts->template['templatedirurl'] = (($request_type == 'SSL') ? HTTPS_SERVER : HTTP_SERVER) . (($request_type == 'SSL') ? DIR_WS_HTTPS_CATALOG : DIR_WS_HTTP_CATALOG) . STS_TEMPLATE_DIR;
...
$sts->template['breadcrumbs'] = $breadcrumb->trail(' &#62 ');
