...
foreach($template16_blocks as $block){
    ...
    if (is_array($block)){
        ...
        if (!$is_enabled){
        ...
        } elseif(!empty($block['filename'])){

            ob_start();

                eval('?>'.get_block_content('template16', $block['block_name']).'<?php;');
            ...
            switch( strtolower( $block['type'] ) ){
                ...
                case 'related':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't16_xsell_products-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featured_categories':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't16_featured_categories-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featured_manufacturers':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't16_featured_manufacturers-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'hot':
                    ...
                    $temp_file = 't16_hot_products-' . $language . '.cache';
                ...
                case 'recommended':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't16_recommended_products-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featuredgroup1':
					...
					include(DIR_FS_CATALOG . DIR_WS_MODULES .  'featuredproduct16.php');
                    $val = ob_get_contents();
         ...
         case 'featuredgroup3':
                ...
                case 'popular':
                    ...
                    $temp_file = 't16_popular_products-' . $language . '.cache';
        ...
        if (USE_CACHE=='true'){
            ...
            $temp_file = 't16_' . $block . '-' . $language . '.cache';
            ...
            if (!read_cache($val, $temp_file, PURGE_CACHE_DAYS_LIMIT)){
                ...
                $val = get_block_content('template16', $block);
