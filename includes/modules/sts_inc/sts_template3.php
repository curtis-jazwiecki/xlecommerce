...
$template3_blocks = array(
    ...
    'featured_products' => array( 
        ...
        'parameters'=>array('custom'=>true, 'on_home_page'=>true, 'max_count'=>'9', 'items_per_row'=>'5'),  
    ...
    'infobox_06' => array( 
            ...
            'parameters'=>array('custom'=>true, 'on_home_page'=>true, 'max_count'=>'10', 'items_per_row'=>'5'),  
...
foreach($template3_blocks as $block){
    ...
    if (is_array($block)){
            ...
            switch( strtolower( $block['type'] ) ){
                ...
                case 'related':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't3_xsell_products-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featured_categories':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't3_featured_categories-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featured_manufacturers':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't3_featured_manufacturers-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'hot':
                    ...
                    $temp_file = 't3_hot_products-' . $language . '.cache';
                ...
                case 'recommended':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't3_recommended_products-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'popular':
                    ...
                    $temp_file = 't3_popular_products-' . $language . '.cache';
        ...
        if (USE_CACHE=='true'){
            ...
            $temp_file = 't3_' . $block . '-' . $language . '.cache';

            if (!read_cache($val, $temp_file, PURGE_CACHE_DAYS_LIMIT)){

                $val = get_block_content('template3', $block);
