...
foreach($template13_blocks as $block){
    ...
    if (is_array($block)){
        ...
        if (!$is_enabled){
            ...
            ob_start();
                ...
                eval('?>'.get_block_content('template13', $block['block_name']).'<?php;');
            ...
            switch( strtolower( $block['type'] ) ){
                ...
                case 'related':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't13_xsell_products-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featured_categories':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't13_featured_categories-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'featured_manufacturers':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't13_featured_manufacturers-' . $language . '.cache' . $_GET['products_id'];
                ...
                case 'hot':
                    ...
                    $temp_file = 't13_hot_products-' . $language . '.cache';
                ...
                case 'recommended':
                    ...
                    if (isset($_GET['products_id']) && !empty($_GET['products_id'])){
                        ...
                        $temp_file = 't13_recommended_products-' . $language . '.cache' . $_GET['products_id'];
         ...
         case 'featuredgroup3':
                ...
                case 'popular':
                    ...
                    $temp_file = 't13_popular_products-' . $language . '.cache';
        ...
        if (USE_CACHE=='true'){
            ...
            $temp_file = 't13_' . $block . '-' . $language . '.cache';
            ...
            if (!read_cache($val, $temp_file, PURGE_CACHE_DAYS_LIMIT)){
                ...
                $val = get_block_content('template13', $block);
