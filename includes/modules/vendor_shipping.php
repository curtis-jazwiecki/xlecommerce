                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                ...
                                                <td class="main" colspan="3"><b><?php echo $quotes[$i]['module']; ?></b>&nbsp;<?php if (isset($quotes[$i]['icon']) && tep_not_null($quotes[$i]['icon'])) {
                        echo $quotes[$i]['icon'];
                    } ?></td>
...
// Javascript patch
                                                        ...
                                                        echo tep_draw_radio_field('shipping_' . $vendor_id, $quotes[$i]['id'] . '_' . $quotes[$i]['methods'][$j]['id'] . '_' . $shipping_tax, $checked, 'id="shipping_radio_' . $radio_buttons . '_' . $vendor_id . '" onclick="onePage.setShippingMethod($(this));onePage.updatePayment();onePage.updateOrderTotals();"');
