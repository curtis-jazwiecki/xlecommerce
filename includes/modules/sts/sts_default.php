<?php
/*
$Id: sts_default.php,v 1.0.5 2006/23/09 09:36:00 rigadin Exp $
...
* 
* v1.0.5: added parameter MODULE_STS_INFOBOX_STATUS for infobox templates.
*/
...
class sts_default {
  ...
  function sts_default (){
    ...
    $this->description = MODULE_STS_DEFAULT_DESCRIPTION.' (v1.0.5)';
	$this->sort_order=1;
  }
...
//======================================
    ...
    function keys() {
      return array('MODULE_STS_DEFAULT_STATUS', 'MODULE_STS_DEBUG_CODE' ,'MODULE_STS_DEFAULT_NORMAL', 'MODULE_STS_TEMPLATE_FOLDER','MODULE_STS_TEMPLATE_FILE', 'MODULE_STS_INFOBOX_STATUS');
    }
