<?php
/*
$Id: sts_product_info.php,v 1.0.6 2005/12/12 09:36:00 Rigadin Exp $
...
STS v4 module for product_info.php by Rigadin (rigadin@osc-help.net)
*/
...
class sts_product_info {
  ...
  function sts_product_info (){
    ...
    $this->description = MODULE_STS_PRODUCT_INFO_DESCRIPTION.' (v1.0.6)';
	$this->sort_order=3;
