...
<?
     ...
     while ($new_products = tep_db_fetch_array($newproduct_query)) {
       ...
       $new_products['products_image'] = (tep_not_null($new_products['products_mediumimage']) ? $new_products['products_mediumimage'] : $new_products['products_image']);
