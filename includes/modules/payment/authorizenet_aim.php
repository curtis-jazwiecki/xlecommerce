   ...
   // Display Credit Card Information on the Checkout Confirmation Page
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('authorizenet_aim_cc_owner', $_POST['authorizenet_aim_cc_owner']) .
                               tep_draw_hidden_field('authorizenet_aim_cc_expires_month', $_POST['authorizenet_aim_cc_expires_month']) . 
                               tep_draw_hidden_field('authorizenet_aim_cc_expires_year', $_POST['authorizenet_aim_cc_expires_year'], -2) .
...
/*
  ...
  // If the response code is not 1 (approved) then redirect back to the payment page with the appropriate error message
    ...
    function after_process() {
      global $insert_id;
      if(MODULE_PAYMENT_AUTHORIZENET_AIM_AUTHORIZATION_TYPE == 'Authorize'){ 
          $capture_status = '0';          
      }else{ 
          $capture_status = '1';          
      }
