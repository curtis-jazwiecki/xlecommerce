...
// class methods
    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
                         ...
                         'fields' => array(array('title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_OWNER,
                                           ...
                                           array('title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CVV,
                                                 'field' => tep_draw_input_field('authorizenet_cc_cvv','',"size=4, maxlength=4"))));
    ...
    function pre_confirmation_check() {
      ...
      $result = $cc_validation->validate($HTTP_POST_VARS['authorizenet_cc_number'], $HTTP_POST_VARS['authorizenet_cc_expires_month'], $HTTP_POST_VARS['authorizenet_cc_expires_year'], $HTTP_POST_VARS['authorizenet_cc_cvv']);
      $error = '';
      switch ($result) {
        case -1:
      ...
      $this->cc_cvv = $HTTP_POST_VARS['authorizenet_cc_cvv'];
    }
    ...
    function confirmation() {
      ...
      $confirmation = array('title' => $this->title . ': ' . $this->cc_card_type,
                            'fields' => array(array('title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_OWNER,
                                            ...
                                            array('title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CVV,
                                                    'field' => $HTTP_POST_VARS['authorizenet_cc_cvv'])));
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('x_Login', MODULE_PAYMENT_AUTHORIZENET_LOGIN) .
                               ...
                               tep_draw_hidden_field('x_card_code', $this->cc_cvv) .
