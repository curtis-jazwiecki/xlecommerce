...
// define the filenames used in the project
 ...
 // Add-on store locator 
  define('FILENAME_STORELOCATOR', 'store_locator.php');
 ...
 // Added for product comparison
  ...
  //mod for parent-child functionality by (MA) EOF
    ...
    //BOF:Recomended product
    define('FILENAME_RECOMENDED_PRODUCTS', 'recomended.php');
    //BOF:Recomended product
    
    define('FILENAME_MY_POINTS', 'my_points.php'); //Points/Rewards Module V2.1rc2a
  define('FILENAME_MY_POINTS_HELP', 'my_points_help.php'); //Points/Rewards Module V2.1rc2a
