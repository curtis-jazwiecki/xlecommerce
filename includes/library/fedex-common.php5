...
function getProperty($var){
	...
	if($var == 'shipaccount') Return 'xxxx';
	if($var == 'billaccount') Return 'xxxx';
	if($var == 'dutyaccount') Return 'xxxx';
	if($var == 'accounttovalidate') Return 'xxxx';
	if($var == 'meter') Return 'xxxx';
	...
	if($var == 'pickuplocationid') Return '72601';
	...
	if($var == 'dispatchlocationid') Return '72601';
	...
	if($var == 'trackingnumber') Return '123';
	if($var == 'trackaccount') Return '510087461';
	if($var == 'shipdate') Return '2010-06-06';
	if($var == 'account') Return '510087461';
	...
	if($var == 'freightaccount') Return '510087461';
