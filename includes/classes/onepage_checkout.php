    ...
    //require(DIR_WS_MODULES . 'vendor_shipping.php');
      ...
      /**/
...

        {
            ...
            if (isset($_POST['products_' . $vendor_id])){
                ...
                list($module, $method, $ship_tax) = explode("_", $shipping_data);
                ...
                $quote = $shipping_modules->quote($module, $method, $vendor_id,$vendor_data);
                ...
                if ($module=='free'){
                    ...
                    $quote[0]['methods'][0]['title'] = $title = FREE_SHIPPING_TITLE;

                    $quote[0]['methods'][0]['cost'] = $cost = '0';

                }

            } else {

                $quote = $shipping_modules->cheapest($vendor_id, $vendor_data['qty']);

                list($module, $method) = explode('_', $quote['id']);
            ...
            //{
...

                {
                    ...
                    //$quote = $shipping_modules->quote($method, $module, $vendor_id, $total_count);
