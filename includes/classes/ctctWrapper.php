 ...
 */
	...
	class Utility
	{
		...
		public function __construct()
		{
			...
			$this->setApiKey('499bc5ae-96ad-49c8-b660-b2ef8a2e91c8');
			$this->setApiPath('https://api.constantcontact.com');
			$this->setLogin('tech1developer');
			$this->setPassword('tech124');
	...
	class ContactsCollection
	{
		...
		*/
		public function updateContact($contactId, $contact)
		{
			...
			//BOF: mod
			*/
			$existingContact = $this->listContactDetails($contactId);
			//EOF: mod
