  ...
  var $sts_block, $template,
    ...
    function sts (){
        ...
        if(checkmobile2()) {
            ...
            if (MOBILE_TEMPLATE_FOLDER =='') {
                $mobile_template_folder = 'sts_templates/full/template6/';
            } else {
                $mobile_template_folder = 'sts_templates/full/' . MOBILE_TEMPLATE_FOLDER . '/';
            }
            ...
            if(isset($_GET['switch_flag']) || isset($_SESSION['switch_template_flag'])){
                ...
                if($_SESSION['switch_template_flag'] ){
                    ...
                    define('STS_TEMPLATE_DIR', DIR_WS_INCLUDES . $mobile_template_folder);
...
// If we use template, ask to module what file(s) to include for building fields
  ...
  function replace (){
	...
	// Note that since v3.0, stylesheet is not defined here but in the template file, allowing different stylesheet for different template.
     ...
     $this->template['headertags'] .= '<script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>' . "\n" . 

                                      '<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>' . "\n";

    $this->template['headertags'] .= '<script type="text/javascript" src="ext/jQuery/obn.js"></script>' . "\n";
