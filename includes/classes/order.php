...
/*QUERY Modified fo Order Tracking*/
	  ...
	  //PWA customers_dummy_account columns added to query
       $order_query = tep_db_query("select customers_id, customers_name, customers_company, customers_street_address, customers_suburb, customers_city, customers_postcode, customers_state, customers_country, customers_telephone, customers_email_address, customers_address_format_id, delivery_name, delivery_company, delivery_street_address, delivery_suburb, delivery_city, delivery_postcode, delivery_state, delivery_country, delivery_address_format_id, billing_name, billing_company, billing_street_address, billing_suburb, billing_city, billing_postcode, billing_state, billing_country, billing_address_format_id, payment_method, cc_type, cc_owner, cc_number, cc_expires, currency, currency_value, date_purchased, orders_status, usps_track_num, usps_track_num2, ups_track_num, ups_track_num2, fedex_track_num, fedex_track_num2, dhl_track_num, dhl_track_num2, extra_track_num, last_modified, customers_dummy_account from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
...
//Array Modified For Order Tracking
...
// PWA EOF
      ...
      $index = 0;
      $orders_products_query = tep_db_query("select orders_products_id, products_id, products_name, products_model, products_price, products_tax, products_quantity, final_price, is_ok_for_shipping from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . (int)$order_id . "'");
...
// EOF Separate Pricing Per Customer
      ...
      for ($i=0, $n=sizeof($products); $i<$n; $i++) {
        //vendor
        //$temp_vendor = get_vendor_id_by_product($products[$i]['id']);
        $this->products[$index] = array('qty' => $products[$i]['quantity'],
                                        ...
                                        'id' => $products[$i]['id'],
										'in_store_pickup' => $products[$i]['in_store_pickup'],
										'is_ok_for_shipping' => $products[$i]['is_ok_for_shipping'],
//MVS start
