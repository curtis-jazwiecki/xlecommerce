...
*/
		...
		elseif (STORE_STOCK == 'true' && STORE_STOCK_LOW_INVENTORY == 'true')
		  ...
		  $list_box_contents[$row][$column] = array('align' => 'left',
													'params' => 'class="productListing-data" ');
		  $text_display = '<table cellpadding="0" border="0" cellspacing="0" width="100%" style="margin: 0 0 8px 0;">';
		  $text_display .= '<tr valign="top" height="150px">';
		  $text_display .= '<td width="15"></td>';
		  $text_display .= '<td width="100" align="center" valign="top">DISPLAY_PRODUCT_IMAGE</td>';
		  $text_display .= '<td width="15"></td>';
		  $text_display .= '</tr>';
		  $text_display .= '<tr valign="top">';
		  $text_display .= '<td></td>';
		  $text_display .= '<td class="smallText">DISPLAY_PRODUCT_NAME<br /><br /></td>';
		  $text_display .= '<td></td>';
		  $text_display .= '</tr>';
		  $text_display .= '<tr valign="top">';
		  $text_display .= '<td></td>';
		  $text_display .= '<td class="smallText" align="right">DISPLAY_PRODUCT_STOCK<br /><br /></td>';
		  $text_display .= '<td></td>';
		  $text_display .= '</tr>';
		  $text_display .= '<tr valign="top">';
		  $text_display .= '<td></td>';
		  $text_display .= '<td class="smallText" align="right">DISPLAY_PRODUCT_PRICE<br /><br /></td>';
		  $text_display .= '<td></td>';
		  $text_display .= '</tr>';
		  $text_display .= '</table>';
