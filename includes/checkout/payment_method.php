    ...
    if ($confirmation !== false){
      for ($j=0, $n2=sizeof($confirmation['fields']); $j<$n2; $j++) {
        ...
        '</tr>';
            ...
            $inputFields .= '<script>function jsValidation'.$selection[$i]['id'].' () { '. ( method_exists($GLOBALS[$selection[$i]['id']], 'opc_javascript_validation') ? $GLOBALS[$selection[$i]['id']]->opc_javascript_validation() : ' ').' } </script>';
