...
<?php echo tep_draw_input_field('billing_zipcode', (isset($billingAddress) ? $billingAddress['postcode'] : ''), 'class="required" style="width:43%;float:left;"'); ?>
...
<?php if(!tep_session_is_registered('customer_id')){ ?>
 ...
 <tr>
  ...
  <td class="main"><?php echo ENTRY_TELEPHONE; ?><br><?php
