...
?>
         <tr>
          ...
          <td class="main" id="stateCol"><?php echo tep_draw_input_field('state', $address['entry_state']) . '&nbsp;' . (tep_not_null(ENTRY_STATE_TEXT) ? '<span class="inputRequirement">' . ENTRY_STATE_TEXT . '</span>' : ''); ?></td>
         </tr>
<?php
  }
?>
