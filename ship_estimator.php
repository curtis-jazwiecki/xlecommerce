...
////
  ...
  switch ($action) {
    ...
    case 'process':
      ...
      if (!tep_session_is_registered ('customer_id') && (!tep_not_null ($_POST['shippostcode']) || (!tep_not_null ($_POST['shipzone']) && SHIP_ESTIMATOR_USE_ZONES == 'true')  || (!tep_not_null ($_POST['shipcountry']) ))) {
