    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading">Sign up for our Newsletter!</td>
...
<form action="?action=newsletter_signup" method="post">
    <input type="text" name="newsletter_name" placeholder="First Name" class="footer_textbox">
    <input type="text" name="newsletter_email" placeholder="Email Address" class="footer_textbox">
    <input type="submit" value="Sign Up!" class="footer_sub">
</form>
