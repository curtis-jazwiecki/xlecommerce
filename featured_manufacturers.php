...
*/
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_FEATURED_MANUFACTURERS);

  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_FEATURED_MANUFACTURERS));
?>
...
?>
          <tr>
            ...
            <td align="right" valign="middle" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_FEATURED_MANUFACTURERS, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $featured_products['products_id']) . '">' . tep_image_button('button_in_cart.gif', IMAGE_BUTTON_IN_CART) . '</a>'; ?></td>
          </tr>
          <tr>
